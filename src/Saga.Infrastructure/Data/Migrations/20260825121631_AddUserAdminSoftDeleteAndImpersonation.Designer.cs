...
namespace Saga.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260825121631_AddUserAdminSoftDeleteAndImpersonation")]
    partial class AddUserAdminSoftDeleteAndImpersonation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Saga.Core.Domain.ImpersonationSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Saga.Core.Domain.TeamChatSeen", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TeamThreadId", "UserId")
                        .IsUnique();

                    b.ToTable("TeamChatSeen");
                });

            modelBuilder.Entity("Saga.Core.Domain.TeamMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TeamThreadId", "CreatedAt");

                    b.ToTable("TeamMessages");
                });

            modelBuilder.Entity("Saga.Core.Domain.TeamMessageMention", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("TeamMessageMentions");
                });

            modelBuilder.Entity("Saga.Core.Domain.TeamThread", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Saga.Core.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("6f9e2f9e-0001-4a7e-9f10-000000000003"),
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 7, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("6f9e2f9e-0001-4a7e-9f10-000000000004"),
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 7, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("Saga.Core.Domain.ImpersonationSession", b =>
                {
                    b.HasOne("Saga.Core.Domain.User", "AdminUser")
                        .WithMany()
                        .HasForeignKey("AdminUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Saga.Core.Domain.User", "TargetUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Saga.Core.Domain.TeamChatSeen", b =>
                {
                    b.HasOne("Saga.Core.Domain.TeamThread", "Thread")
                        .WithMany("Seen")
            ...
            modelBuilder.Entity("Saga.Core.Domain.TeamMessageMention", b =>
                {
                    b.HasOne("Saga.Core.Domain.TeamMessage", "TeamMessage")
                        .WithMany("Mentions")
